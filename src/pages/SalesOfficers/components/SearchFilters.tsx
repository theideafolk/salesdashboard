// SearchFilters.tsx
// Component for search and filtering controls for sales officers
    ...
    <div className="card mb-6">
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
        ...
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            placeholder="Search by name, employee ID, phone number..."
        ...
        {(selectedFilters.reportingManager || !selectedFilters.activeOnly) ? (
          <button
      ...
      {showFilters && (
        <div className="mt-4 pt-4 border-t border-slate-200 grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Reporting Manager filter - Only show for admin */}
          {isAdmin && (
            <div>
              ...
              <select
                value={selectedFilters.reportingManager}
                onChange={(e) => onFilterChange('reportingManager', e.target.value)}
